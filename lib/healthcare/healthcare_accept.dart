...
class _HealthcareAcceptState extends State<HealthcareAccept> {
  ...
  // Filters the global list for requests specifically for THIS Healthcare
  // Inside _HealthcareAcceptState
  List<Map<String, String>> get myRequests {
    // 1. Normalize the email of the Healthcarecurrently logged in
